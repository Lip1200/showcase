export const translations = {
  fr: {
    ...
    personalInfo: {
      ...
      experience: [
        ...
        },
        {
          ...
          company: "Diverses institutions",
          period: "2010 - 2022",
          description: "Accompagnement pédagogique et social"
        }
      ],
      education: [
        {
        ...
        {
          degree: "Bachelor en Travail Social, spécialisation Éducation Spécialisée",
          school: "HES-SO",
          year: "2017"
        }
      ]
    ...
    navigation: {
      ...
      projects: "Projets",
      contact: "Contact",
      detailedAbout: "À propos détaillé"
    },
    labels: {
      email: "Email",
      github: "GitHub",
    ...
    personalInfo: {
      ...
      experience: [
        ...
        },
        {
          ...
          period: "2010 - 2022",
          description: "Educational and social support"
        }
      ],
      education: [
        {
        ...
        {
          degree: "Bachelor in Social Work, specialization in Special Education",
          school: "HES-SO",
          year: "2017"
        }
      ]
